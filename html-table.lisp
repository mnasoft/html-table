...
(defun round-val (a &optional (out nil))
  (cond
    ...
    ((and (numberp a ) (< (abs a) 0.01))   (format out "~A" (string-trim " " (format out "~6,3E" a))))
    ((and (numberp a ) (< (abs a) 0.1))    (format out "~A" (string-trim " " (format out "~7,5F" a))))
    ((and (numberp a ) (< (abs a) 1))      (format out "~A" (string-trim " " (format out "~7,4F" a))))
    ((and (numberp a ) (< (abs a) 10))     (format out "~A" (string-trim " " (format out "~7,3F" a))))
    ((and (numberp a ) (< (abs a) 100))    (format out "~A" (string-trim " " (format out "~7,2F" a))))
    ((and (numberp a ) (< (abs a) 1000))   (format out "~A" (string-trim " " (format out "~7,1F" a))))
    ((and (numberp a ) (< (abs a) 10000))  (format out "~A" (string-trim " " (format out "~7,0F" a))))
    ((and (numberp a ) (< (abs a) 100000)) (format out "~A" (string-trim " " (format out "~7,0F" a))))
    ((and (numberp a ))                    (format out "~A" (string-trim " " (format out "~6,3E" a))))
    (T                                     (format out "~A"    a))))
...
(defun type_tr(a &optional (out nil))
  (cond
    ...
    ((and (numberp a ) (< (abs a) 10000))  (format out "<td>~7,0F</td>" a))
    ((and (numberp a ) (< (abs a) 100000)) (format out "<td>~7,0F</td>" a))
